...
export default function Ubs() {
    return (     
      <>
      <div className="jumbotron card card-image text-white bg-dark " >
      {/* style="background-color: rgba(0,0,0,0);" */}
          <p className="text-center">Bem vindo ao sistema SOS,  - </p>
          <h1 className="display-4 text-warning  font-weight-bold">UBS's</h1>
          <button type="button" className="btn btn-warning btn-lg font-weight-bold" data-toggle="modal" data-target="#cadastroUBSModal">
            CADASTRAR NOVA UBS
          </button>
              ...
              <tr>
                <th className="align-middle text-left" scope="row "></th>
                  ...
                  <div className="btn-group">
                    <button type="button" className="btn btn-outline-info  font-weight-bold" data-toggle="modal" data-target="#atualizarUBSModal">
                      EDITAR
                    </button>

                  {/* <!-- Modal para atualizar UBS --> */}
                  <div className="modal fade text-dark" id="atualizarUBSModal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                      <div className="modal-content">
                        <div className="modal-header">
                          <h5 className="modal-title" id="staticBackdropLabel">ATUALIZAR UBS</h5>
                          <button type="button" className="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                        <div className="modal-body">
                          <form id="atualizarUBS" className="container-fluid" action="#" method="post">
                            <input type="hidden" name="id" />
                            <div className="row">
                              <div className=" col-sm-5 form-group">
                                <label className="col-form-label">Cadastrado por:</label>
                                <select className="custom-select mr-sm-2 border border-primary" name="cadastrado_por_id">
                            ...
                            <div className="form-group">
                              <input type="text" name="nome" className="form-control border border-primary"  />
                            </div>

                            <div className="form-group">
                              <textarea className="form-control border border-primary" name="descricao"></textarea>
                            </div>

                            <div className="form-group">
                              <input type="text" name="endereco" className="form-control border border-primary"  />
                            </div>

                            <div className="row">
                              <div className="form-group col-lg-8">
                                <input type="text" name="bairro" className="form-control border border-primary" />
                              </div>
                            </div>
                            ...
                            <div className="row">
                              <div className="col-7 col-md-6 mr-auto form-group">
                                <input type="text" name="cep" className="form-control border border-primary" />
                              </div>

                              <div className="col-7 col-md-6 form-group">
                                <input type="text" name="telefone" className="form-control border border-primary" />
                              </div>
                            </div>

                            <div className="row">
                              <div className="col-7 col-md-6 mr-auto form-group">
                                <input type="text" name="latitude" className="form-control border border-primary"  />
                              </div>

                              <div className="col-7 col-md-6 form-group">
                                <input type="text" name="longitude" className="form-control border border-primary" />
                              </div>
                            </div>
                        ...
                        <div className="modal-footer d-flex justify-content-between align-items-center">
                          ...
                          <div className="d-flex">
                            <input type="reset" className="btn btn-outline-warning mx-2" value="LIMPAR" />
                            <input type="submit" className="btn btn-primary mx-2" value="ATUALIZAR" />
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <form method="post">
                    ...
                    <button type="submit" className="btn btn-outline-danger  font-weight-bold">
  ...
  <div className="modal fade text-dark" id="cadastroUBSModal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
      <div className="modal-content">

        <div className="modal-header">
          <h5 className="modal-title" id="staticBackdropLabel">CADASTRAR UBS</h5>
          <button type="button" className="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        ...
        <div className="modal-body">
          ...
          <form id="cadastrarUBS" className="container-fluid" action="#" method="post">
            <div className="row">
              <div className=" col-sm-5 form-group">
                <label className="col-form-label">Cadastrado por:</label>
                <select className="custom-select mr-sm-2 border border-primary" name="cadastrado_por_id">
            ...
            <div className="row">
              <div className="col-7 col-md-6 mr-auto form-group">
                <input type="text" name="latitude" className="form-control border border-primary" placeholder="Latitude (opcional)" />
              </div>

              <div className="col-7 col-md-6 form-group">
                <input type="text" name="longitude" className="form-control border border-primary" placeholder="Longitude (opcional)" />
              </div>
            </div>
        ...
        <div className="modal-footer d-flex justify-content-between align-items-center">
          ...
          <div className="d-flex">
            <input type="reset" className="btn btn-outline-warning mx-2" form="cadastrarUBS" value="LIMPAR" />
            <input type="submit" className="btn btn-primary mx-2" form="cadastrarUBS" value="CADASTRAR" />
          </div>
        </div>
      </div>
    </div>
