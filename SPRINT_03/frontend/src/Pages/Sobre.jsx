        ...
        <div className="row text-center">
                ...
                <div className="col-md-6 col-lg-4 item">
                    <div className="box"><img className="rounded-circle  w-50" src="./img/eliana.jpg"  />
                        <h3>Eliana Souza</h3>
                        <div>
                            <a href="https://github.com/Elianars" className="text-dark"><i className="fab fa-github"></i></a>
                ...
                <div className="col-md-6 col-lg-4 item">
                    <div className="box"><img className="rounded-circle  w-50" src="./img/mit.jpg"  />
                        ...
                        <div>
                            <a href="https://github.com/matsuboshi" className="text-dark"><i className="fab fa-github"></i></a>
                ...
                <div className="col-md-6 col-lg-4 item">
                    <div className="box"><img className="rounded-circle  w-50" src="./img/nay.jpg" />
                        <h3>Nayara Suelen</h3>
                        <div >
                            <a href="https://github.com/NayDev" className="text-dark"><i className="fab fa-github"></i></a>
                ...
                <div className="col-md-6 col-lg-4 item">
                    <div className="box"><img className="rounded-circle  w-50" src="./img/roger.jpg"  />
                        <h3>Willi Roger</h3>
                        <div>
                            <a href="https://github.com/williroger" className="text-dark"><i className="fab fa-github"></i></a>
